...
CMD cd /etc/proc_profiles && ./generate -l /etc/apt_repository/available_package_table && nginx && cd /etc/app && bundle exec rake db:migrate && bundle exec ruby web-frontend.rb
